CLASS.AddClass("BREACH", {
	...
	lang = {
		...
		desc = {
			English = "The Breach always wears some body armor. Once and only once he can activate his ability, granting him 50 more health and a heavy shotgun to blast himself through the world!"
		}
	}
})
