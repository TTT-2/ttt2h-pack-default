...
CLASS.AddClass("PREDATOR", {
	...
	lang = {
		...
		desc = {
			en = "The Predator is able to track one player through the wall every 2 minutes by using their ability while focusing the player. They have no passive ability.",
			fr = "Le Prédateur peut suivre un joueur à travers les murs toutes les 2 minutes en utilisant sa capacité à le cibler. Il n'a pas de capacité passive.",
			ru = "Хищник может отслеживать одного игрока через стену каждые 2 минуты, используя свои способности при фокусировке игрока. У него нет пассивных способностей."
		}
	}
})
