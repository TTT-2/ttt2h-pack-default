...
CLASS.AddClass("PREDATOR", {
	...
	lang = {
		...
		desc = {
			...
			French = "Le Prédateur peut suivre un joueur à travers les murs toutes les 2 minutes en utilisant sa capacité à le cibler. Il n'a pas de capacités passives.",	
